 ...
 * <p>
 * Annotate a {@link se.jbee.inject.bind.ModuleWith} implementation that should
 ...
 * {@link se.jbee.inject.bind.ModuleWith}. If the provided {@link Class} is not
 * an {@link Annotation} type the module is ignored.
 * </p>
 *
 * <h3>Providing Bundles via ServiceLoader</h3>
 * <p>
 * Annotate a {@link se.jbee.inject.bind.Bundle} implementation that should load
 ...
 * {@link se.jbee.inject.bind.Bundle}s to the {@link Injector} context don't
