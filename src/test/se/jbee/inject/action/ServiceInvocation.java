 ...
 * {@linkplain Action}. Thereby a state can be passed between these tow methods. The result
 ...
 * {@linkplain Action} in order to be able to grant the same actual function invocation even
