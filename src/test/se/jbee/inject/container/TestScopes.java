...
public class TestScopes {
	...
	public void thatDependencyTypeScopeEnsuresSingletonPerExactGenericType() {
		...
		InjectronInfo<A> da = new InjectronInfo<TestScopes.A>(resource( A.class ), source, expiry, 1, 2 );
		InjectronInfo<B> db = new InjectronInfo<TestScopes.B>( resource( B.class ), source, expiry, 2, 2 );
		A a = new A();
		B b = new B();
		Provider<A> ia = new ConstantProvider<A>( a );
		Provider<B> ib = new ConstantProvider<B>( b );
