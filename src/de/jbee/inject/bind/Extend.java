...
public final class Extend {
	...
	public static <E extends Enum<E> & Extension<E, T>, T> Name name( Class<E> extension,
			Class<? extends T> type ) {
		return named( extension.getCanonicalName() + ":" + type.getCanonicalName() );
	}

	public static <E extends Enum<E> & Extension<E, T>, T> Name name( E extension,
			Class<? extends T> type ) {
		return named( extension.getClass().getCanonicalName() + "#" + extension.name() + ":"
				+ type.getCanonicalName() );
	}

	public static <E extends Enum<E> & Extension<E, T>, T> Dependency<Class[]> dependency(
			Class<E> extension ) {
