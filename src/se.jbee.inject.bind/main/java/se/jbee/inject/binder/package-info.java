 ...
 * <p>
 * To pick up {@link se.jbee.inject.bind.Bundle}s defined via
 * {@link java.util.ServiceLoader} as part of the
 * {@link se.jbee.inject.Injector} context install the
 * {@link se.jbee.inject.binder.ServiceLoaderBundles} bundle in one of your
 * applications {@link se.jbee.inject.bind.Bundle}s. That is one installed when
 * expanding the root {@link se.jbee.inject.bind.Bundle} of
 ...
 * context install the {@link se.jbee.inject.binder.ServiceLoaderEnvBundles}
 * bundle in one of your applications environment
 * {@link se.jbee.inject.bind.Bundle}s. That is one install when expanding the
 * root {@link se.jbee.inject.bind.Bundle} of
 ...
 * particular {@link java.lang.annotation.Annotation} install the
 * {@link se.jbee.inject.binder.ServiceLoaderAnnotations}
 * {@link se.jbee.inject.bind.Module} as part of the {@link se.jbee.inject.Env}
 * context.
 * </p>
 */
