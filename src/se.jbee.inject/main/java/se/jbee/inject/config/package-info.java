 ...
 * installed {@link se.jbee.inject.bind.Bundle}s and
 * {@link se.jbee.inject.bind.Module} by some form of setting starting from the
 * same root {@link se.jbee.inject.bind.Bundle}. The most common use case is to
 * build {@link se.jbee.inject.config.Edition}s of a software application. This
 ...
 * bootstrapping of the application where the target
 * {@link se.jbee.inject.config.Edition} is defined in the
 * {@link se.jbee.inject.Env} used.
 * </p>
 * <p>
