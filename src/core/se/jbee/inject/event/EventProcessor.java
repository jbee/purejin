 ...
 * The {@link EventPreferences} generated by the {@link EventMirror} can be used
 * to control different aspects of the processing for each event type
 * individually.
 * 
...
public interface EventProcessor extends AutoCloseable {
	 ...
	 * setup created by {@link EventModule#handle(Class)} as no explicit
	 ...
	 * the method signature and {@link EventPreferences}.
	 * 
	 ...
	 * is set {@code true} in which case it synchronises at the end of the
	 ...
	 *             signature permits it. This is {@link Throwable} as
